import os,xbmc,xbmcgui,downloader
...
def install(name,url):
	...
	if xbmc.getCondVisibility('system.platform.android'):
		...
		xbmcgui.Dialog().ok(user.name, "[COLOR white]Launching the installer[/COLOR]" , "[COLOR white]You will now be asked to install[/COLOR] [COLOR ffff0000][B]%s[/COLOR][/B]"%name)
